        ...
        <div className="mx-24 py-10">
            <div className="grid grid-cols-2 gap-10">
                ...
                <div className="order-1">
                    <p className="text-lg text-gray-700">The goal of this events management system is save customers time and provide best service in his budget. This system can monitor multiple events at a time and customers can give feedback to community center owner or party center owner to improve their service.</p>
                    <ul className="my-5">
