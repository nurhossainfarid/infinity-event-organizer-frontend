    ...
    return (
        <div>
            <div className="flex justify-between my-5">
                <h1 className="text-3xl text-center dashboard-header">Custom Package</h1>
            </div>
            <form onSubmit={handleSubmit(onSubmit)} action="" className="grid grid-cols-2">
                ...
                <div className="form-control">
                    <label className="label">
                    <span className="label-text text-black text-lg">Select Location</span>
                    </label>
                    <input type="text" className="input input-bordered w-full max-w-xs"
                        {...register("address", { 
                            required: {
                ...
                <div className="form-control">
                    <label className="label">
                        <span className="label-text text-black text-lg">Needed Extra Service</span>
                    </label>
                    <input type="text" className="input input-bordered w-full max-w-xs"
                        {...register("name", { 
                            required: {
