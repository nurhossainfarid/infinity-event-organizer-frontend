...
const Banner = () => {
    return (
        ...
        >
          <SwiperSlide className="relative">
            ...
            <div className="absolute w-2/5 top-48 text-white left-16">
              ...
              <div className="mt-20 flex gap-10 justify-end ">
                <button class="btn btn-outline border-none bg-secondary hover:bg-primary text-black hover:text-white text-3xl">Order</button>
                <button class="btn btn-outline border-secondary hover:border-none text-secondary hover:bg-secondary hover:text-primary text-3xl">view</button>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide className="relative">
          ...
          <SwiperSlide className="relative">
            <img style={{ height: '800px' }} className="w-full" src={Background5} alt="" />
            <div className="absolute w-2/5 top-48 text-white left-16">
              <div className="slider-title p-5">
                <div className="title text-5xl" data-swiper-parallax="-300">
                  Slide 1
          ...
          <SwiperSlide className="relative">
            <img style={{ height: '800px' }} className="w-full" src={Background6} alt="" />
            <div className="absolute w-2/5 top-48 text-white left-16">
              <div className="slider-title p-5">
                <div className="title text-5xl" data-swiper-parallax="-300">
                  Slide 1
          ...
          <SwiperSlide className="relative">
            <img style={{ height: '800px' }} className="w-full" src={Background7} alt="" />
            <div className="absolute w-2/5 top-48 text-white left-16">
              <div className="slider-title p-5">
                <div className="title text-5xl" data-swiper-parallax="-300">
                  Slide 1
          ...
          <SwiperSlide className="relative">
            <img style={{ height: '800px' }} className="w-full" src={Background8} alt="" />
            <div className="absolute w-2/5 top-48 text-white left-16">
              <div className="slider-title p-5">
                <div className="title text-5xl" data-swiper-parallax="-300">
                  Slide 1
