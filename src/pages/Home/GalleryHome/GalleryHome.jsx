  ...
  return (
    <div className="gallery-container ">
          ...
          <div className="flex justify-between items-center md:gap-5 lg:gap-10">
            <div>
              ...
              <p className="text-sm md:text-md lg:text-lg py-5">
                ...
                গ্যালারি সেকশানে সাথে
              </p>
            </div>
            <div>
              <button
                className="border-2 p-1 lg:p-2 btn-outline btn-white rounded-sm md:text-md 
                             lg:text-lg font-semibold hover:text-white ease-in duration-300 animate-bounce"
              >
                More Service..
              </button>
            </div>
      ...
      <div className="flex justify-center gallery-view-button relative my-10 lg:my-16">
        <button
          className="border-2 rounded-lg border-purple-600 text-purple-600 p-2 text-xl 
