  ...
  return (
    <div className="bg-slate-100 md:py-16 lg:py-28">
      ...
      <section className=" pt-5 md:pt-10 md:mx-10 lg:mx-28">
        ...
        <p
          className="text-sm md:text-md lg:text-lg text-gray-500 mx-auto py-3 lg:py-5 lg:w-1/2 
                text-center"
        >
          আপনিও কন্ট্রিবিউট করতে পারেন আমাদের ব্লগের সাথে, আপনার মূল্যবান
          আইডিয়া গুলো শেয়ার করতে পারেন সবার সাথে
        </p>
      </section>
      <section className="mx-6 md:mx-10 lg:mx-28 mt-10">
        ...
        >
          <SwiperSlide
            className="grid grid-flow-row-dense grid-cols-1 md:grid-cols-2 lg:grid-cols-3 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 bg-white">
                ...
                <div className="m-5 mt-8">
                  ...
                  <p className="text-gray-500">
                    ...
                    reproduced below for those interested. Sections 1.10...
                  </p>
                  <div className="mt-10">
                    <button
                      className="btn btn-secondary text-white hover:bg-fuchsia-600 
                                        "
                    >
                      Read More ...
                    </button>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 bg-white mt-8">
                ...
                <div className="m-5 mt-8">
                  <ul className="flex items-center gap-5 mb-5">
                    ...
                    <li>
                      <h1 className="text-2xl font-bold">
                        5 Steps To Planning A Sweet Party
                      </h1>
                    </li>
                  </ul>
                  <p className="text-gray-500">
          ...
          <SwiperSlide
            className="grid grid-flow-row-dense grid-cols-1 lg:grid-cols-3 grid-rows-1 
                    gap-10 "
          >
          ...
          <SwiperSlide
            className="grid grid-flow-row-dense grid-cols-1 lg:grid-cols-3 lg:grid-rows-1 
                     gap-10"
          >
            <div className="col-span-2">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 bg-white">
