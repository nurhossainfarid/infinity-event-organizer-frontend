...
const HomePackage = () => {
    return (
        <div className="home-package-container">
            ...
            <section>
                <div className="flex flex-col items-center justify-center md:mx-10 lg:mx-0 lg:absolute mt-10 
                    ...
                    lg:pb-32 justify-center items-center w-full">
                        ...
                        hover:scale-95 ease-in duration-300 ">
                            ...
                            home-package-cover">
                                ...
                                text-white">
                                    ...
                                    <h1 className="card-title text-lg md:text-3xl">B.C.P Friday Black Night</h1>
                                    <p className="text-sm md:text-lg font-semibold">Price: $100</p>
                                    <p className="text-sm md:text-lg font-semibold">Time: 3 Hours</p>
                                    <p className="text-sm md:text-lg font-semibold">Maximum: Up to 10 Persons</p>
                                    <p>Decoration</p>
                                    <p>Catering</p>
                        ...
                        hover:scale-95 ease-in duration-300 ">
                            ...
                            home-package-cover">
                                ...
                                <div className="grid grid-cols-1 gap-2 py-10 pb-16 w-4/5 mx-auto relative 
                                text-white">
                                    <h2 className="card-title text-md md:text-2xl">Weddings Celebrations</h2>
                                    <h1 className="card-title text-lg md:text-3xl">W.C.P Friday Black Night</h1>
                                    <p className="text-sm md:text-lg font-semibold">Price: $950</p>
                                    <p className="text-sm md:text-lg font-semibold">Time: 5 Hours</p>
                                    <p className="text-sm md:text-lg font-semibold">Maximum: Up to 50 Persons</p>
                                    <p>Decoration</p>
                                    <p>Catering</p>
                                    <div className="card-actions justify-center">
                                        <button className="btn btn-outline text-white border-white 
                        ...
                        <div className="show-package3 border-8 border-white hover:border-secondary hover:scale-95 
                         ease-in duration-300 ">
                            ...
                            home-package-cover">
                                ...
                                <div className="grid grid-cols-1 gap-2 py-10 pb-16 w-4/5 mx-auto relative    
                                 text-white">
                                    <h2 className="card-title text-md md:text-2xl">Corporate Events</h2>
                                    <h1 className="card-title text-lg md:text-3xl">C.E.P Friday Black Night</h1>
                                    <p className="text-sm md:text-lg font-semibold">Price: $740</p>
                                    <p className="text-sm md:text-lg font-semibold">Time: 10 Hours</p>
                                    <p className="text-sm md:text-lg font-semibold">Maximum: Up to 100 
                                     Persons</p>
                                    <p>Decoration</p>
                                    <p>Catering</p>
                                    <div className="card-actions justify-center">
