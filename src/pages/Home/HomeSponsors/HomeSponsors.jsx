    ...
    <div>
      ...
      <section>
        ...
        {/* <section className="sponsor-bg relative">
                    ...
                    <div className="relative py-16">
                        <h3 className="font-semibold text-sm text-white text-center mb-3">WE PROVIDE AWESOME DEALS</h3>
                        <h1 className="sponsors-header text-white text-center text-5xl animate-bounce">Event Sponsors</h1>
        ...
        {/* <section className="bg-slate-100 py-20">
                    <div className="grid grid-cols-4 gap-5 mx-28">
                        <div className="sponsor-showup-sec bg-white hover:scale-105 hover:border-4 hover:border-secondary ease-in duration-300">
      ...
      <section className="bg-slate-100 pt-10 md:pt-20 lg:pt-48">
        <div className="absolute z-10 -mt-40 ">
          <div className="w-10/12 md:w-1/2 mx-auto create-sponsor-bg relative border-8 border-white">
            <div className="absolute bg-secondary opacity-80 h-full w-full"></div>
            <div className="py-10 lg:py-16 relative">
              <h1
                className="text-center text-xl md:text-3xl lg:text-5xl text-white animate-pulse 
                             mb-3"
              >
                Our Happy Customer
              </h1>
              <p
                className="text-sm md:text-md lg:text-lg text-gray-200 mx-auto py-5 w-11/12 
        ...
        <div className="create-sponsor-bg2 relative">
          ...
          <div className="py-10 lg:py-20 relative z-20 mx-16 md:mx-36">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-32 md:mt-40">
              <div
                className="relative hover:scale-95 hover:border-4 hover:border-white 
                            ease-in-out duration"
              >
                <div className="absolute bg-black opacity-80 h-full w-full"></div>
                <div className="relative text-center py-20">
                  <h1 className="text-white text-2xl text-uppercase font-bold">
                    FUN PARTIES
                  </h1>
