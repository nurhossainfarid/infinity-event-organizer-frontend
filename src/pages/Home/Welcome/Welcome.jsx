  ...
  return (
    <div className="py-24 bg-slate-100">
      <section className="text-center mx-28 ">
        <h1 className="text-5xl welcome-header animate-bounce">
          Welcome to <span className="animate-bounce">E.M.S</span>
        </h1>
        <p className="text-lg pt-5 pb-16 md:mx-48">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-10 mx-28 ">
        <div className="card ease-in-out duration-300 bg-base-100 shadow-xl hover:bg-purple-700 hover:text-white hover:scale-110 ">
          <div className="card-body">
            ...
            <p className="text-base text-slate-500 welcome-p">
              Corem ipsum dolor sit amet consectetur elit sed lusm tempor
        ...
        <div className="card ease-in-out duration-300 bg-base-100 shadow-xl hover:bg-purple-700 hover:text-white hover:scale-110">
          <div className="card-body">
            ...
            <div className="flex justify-end">
              <button className="border-2 read-btn btn-outline btn-secondary w-1/3 text-center rounded-md font-semibold ease-in duration-300 hover:rotate-6">
                Read More....
              </button>
            </div>
          </div>
