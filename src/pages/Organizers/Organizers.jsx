...
const Organizers = () => {
    ...
    useEffect(() => {
        const url = 'http://localhost:5000/v1/organization';
        fetch(url)
            .then(res => res.json())
            .then(data => {
        ...
        <div className="">
            ...
            <div className="organizer-header-bg relative">
                ...
                <div className="relative py-40 flex flex-col justify-center items-center gap-3">
                    <h1 className="text-5xl text-primary uppercase font-semibold">Organization</h1>
            ...
            <div className="bg-slate-100 py-16">
                <div className="mb-20">
                    <h1 className="text-5xl text-secondary organizer-subtext text-center">Best Organizers in Bangladesh</h1>
                    <p className="text-mg text-gray-600 pt-5 text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora, repudiandae.</p>
                </div>
                <div>
                    {
                        ...
                        <div className="organizer-bg relative w-96 mx-28">
                            ...
                            <ul className="text-white flex flex-col gap-1 justify-center items-start ml-8 my-5">
                                <li className="flex items-center gap-2"><ImLocation2 className="text-red-600"></ImLocation2>{organizer.address}</li>
                                ...
                                <li className="flex items-center gap-2"><FaPhoneAlt className="text-red-600"></FaPhoneAlt>{organizer.contactNumber}</li>
                                <li className="flex items-center gap-2"><FaMailBulk className="text-red-600"></FaMailBulk>{organizer.email}</li>
                            </ul>
